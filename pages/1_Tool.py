...
# ── Custom header (cinematic, fixed so it always stays on top) ───────────────
st.markdown("""
<div style="position:fixed; top:0; left:0; right:0; z-index:9999; background:rgba(6,4,15,0.97);
  ...
  <div style="padding:5px 32px; border-bottom:1px solid rgba(201,151,58,0.1);
...
# ── Spacer to push content below the fixed header (~78px: strip 28px + nav 50px) ──
